...
import static server.model.enums.SpellAndTrapIcon.EQUIP;
import static server.model.enums.SpellAndTrapIcon.FIELD;
...
public class AIController {
    ...
    private void activateSpellEffect(Card card) {
        boolean trapActivate = GameController.getInstance().activeTraps(TrapNames.MAGIC_JAMMER);
        if (trapActivate)
            return;
