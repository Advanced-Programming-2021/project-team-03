...
public class Database {
    ...
    public synchronized static void remove(Object object) throws DatabaseException {
    ...
    public synchronized static void save(User user) throws DatabaseException {
        UserJson userJson = new UserJson(user);
        writeToJson(userJson, pathFinder(user));
    }

    public synchronized static void save(Deck deck) throws DatabaseException {
        DeckJson deckJson = new DeckJson(deck);
        writeToJson(deckJson, pathFinder(deck));
    }

    public synchronized static void save(Card card) throws DatabaseException {
        Object object;
